...
if( ! document.getElementById('googleMapAPI') ){
	...
	s.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyB7a9aOxSrO-0GIn6u3GlF0JJTlc5mgV_I&callback=initializeMap';
...
function initializeMap(){
	...
	Clat || (Clat = 21.585329, $("#" + mapCenLat).val(Clat));
	Clng || (Clng = 105.806853, $("#" + mapCenLng).val(Clng));
